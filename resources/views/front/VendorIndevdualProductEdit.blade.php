...
<div class="sectionfixd fixedsecotherpage">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="profsittengs">
                ...
                <form id='submitForm' method="post" enctype="multipart/form-data">
                    @csrf
                                                                     ...
                                                                     <div class="alert alert-danger3 " style="display:none">
                                                                            {{__('front.please fill all required records')}}
                                                                        </div>
                    ...
                    <div class="inputVendorr">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="formItemVendor">
                                    ...
                                    <select id='pmc_id' name='pmc_id' class='form-control select2' required>
                                        ...
                                        <option value='{{$pmc->id}}'@if($product->pmc_id == $pmc->id ) selected @endif>{{$pmc->cat_name}}</option>
                            ...
                            <div class="col-lg-12 col-nd-12 col-sm-12 col-xs-12">
                                <div class="formItemVendor">
                                    <span>{{__('front.Product Name EN')}}*</span>
                                                                    <textarea placeholder="" id='product_name_en' name='product_name_en' value=''required class="TextInputt">{{$product->product_name_en}}</textarea>
                            ...
                            <div class="col-lg-12 col-nd-12 col-sm-12 col-xs-12">
                                ...
                                <textarea placeholder="" id='product_name_ar' name='product_name_ar' value='' required class="TextInputt">{{$product->product_name_ar}}</textarea>
            ...
            @if($media->type == 'image')
             <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 weyy">
            <div class="formItemVendor"> 
                                                                                                                    <a href="{{Voyager::image($media->image)}}" class="Itemmm">
                                                                                                                        <div class="sliderimgItem">
                                                                                                                            <img src="{{Voyager::image($media->image)}}">
                                                                                                                            <button type="button" data-id='{{$media->id}}'  class="Removee RemoveSlide RemoveProductImage" >
              ...
              @endif
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="btn btn-default image-preview-input">
                                                                                    ...
                                                                                    <input type="file" multiple accept="" id='video' name='video[]' onchange="changeVideoPreview(event);" />
                                                                                </div>
                                                                            </span> 
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div class="row sliderimgItemV">
           @if($product->media)  
            
            @foreach($product->media as $media)
            @if($media->type == 'video')                                                                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 weyy">
                                                                                    
                                                                                    <div class="formItemVendor"> 
                                                                                    <div class="sliderimgItem">
                                                                                        <video class="VedioPorUpload"  controls>
                                                                                              <source src="{{Voyager::image($media->video)}}" type="video/mp4">
                                                                                   </video>
                                                                                                    <button type="button" data-id="{{$media->id}}" class="Removee RemoveSlide  RemoveProductImage" >
                                                                                                                               <i class="far fa-trash-alt"></i>
                                                                                                                            </button>  </div>  </div>
                                       ...
                                       @endif
                                        ...
                                        <div style='display:none' class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs" >
                                                ...
                                                <div role="tabpanel" class="tab-pane fadeIn active" id="home" aria-labelledby="home-tab">
                                                    <div class="tabcontent-grids">
                                                        <div class="setforms">
                                                            ...
                                                            <img id='f_prev_img2' src="{{Voyager::image($product->image)}}">
                                                            @endif
                                                            </div>
                                                                </div>
                                                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="formItemVendor">
                                    ...
                                    <select id='currency_id' class='form-control select2' name='currency_id'required>
                                        @if($currencies)
                                        @foreach( $currencies as $currency)
                                        <option value='{{$currency->id}}' @if($product->currency_id == $currency->id ) selected @endif>{{$currency->name}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="formItemVendor">
                                            ...
                                            <input type="number" step="0.01" id='min_price' name='min_price' value='{{$product->min_price}}' class="inputvendor"required placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="formItemVendor">
                                            <span>{{__('front.max price')}} *</span>
                                            <input type="number" step="0.01" id='max_price' name='max_price' value='{{$product->max_price}}' class="inputvendor" required placeholder="">
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="formItemVendor">
                                            ...
                                            <input type="number" id='min_order' name='min_order' value='{{$product->min_order}}'class="inputvendor" required placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!--                <input type="number" id='max_order' name='max_order'  value='{{$product->max_order}}' class="inputvendor" required placeholder="">-->
                            <!--            </div>-->
                            <!--        </div>-->
                            ...
                            <div class="col-lg-6 col-nd-6 col-sm-6 col-xs-12">
                                <div class="formItemVendor">
                                    ...
                                    <input type="text" id='load_time' name='load_time' value='{{$product->load_time}}' class="inputvendor" required placeholder="">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="formItemVendor">
                                ...
                                <textarea placeholder="My Info" id='product_desc'  value='' name='product_desc' required class="textarea"> {{$product->product_desc}} </textarea>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="formItemVendor">
                                ...
                                <textarea placeholder="My Info" id='product_desc_ar'  value='' name='product_desc_ar' required class="textarea">{{$product->product_desc_ar}}</textarea>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                <div>
                                            ...
                                            <div class="keyword_table">
                                                <table id="keywordstable" class="table table-bordered" style='display:@if(empty($first_page_keywords)) none @endif'>
                                                    <thead>
                                                       
                                                        <tr>
                                                            <th><p>{{__('front.Keyword')}} </p></th>
                                                            <th><p>{{__('front.From')}} </p></th>
                                                            <th><p>{{__('front.To')}} </p></th>
                                                            <th><p>{{__('front.Price')}} </p></th>
                                                             <th>
                                                                <p>{{__('front.Total')}} </p>
                                                            </th>
                                                            <th><p>{{__('front.Delete')}} </p></th>
                                                        </tr>
                                                        
                                                    </thead>
                                                    <tbody>
 
@if(!empty($first_page_keywords))
@foreach($first_page_keywords as $keyword)

<tr>
    <td><p>{{$keyword->keyword}}</p></td>
    <td><p>{{$keyword->date_from}}</p></td>
    <td><p>{{$keyword->date_to}}</p></td>
    <td><p>{{$keyword->price}}</p></td>
    <td><p>{{$keyword->total}}</p></td>
    <td>  <button  type="button" class="btn btn-danger f_delete2" title="delete"><i class="far fa-trash-alt"></i> </button></td>
    </tr>
...
@endif
                                            ...
                                            <div>
                                                ...
                                                <span id='d_error' style="display:none">please select keyword,date from and date to</span>
                                                <div class="row">
                                                    <div class="col-lg-3 col-nd-3 col-sm-3 col-xs-12">
                                                        <div class="formItemVendor">
                                            ...
                                            <div class="keyword_d_table keyword_table" style='display:@if(empty($dynamic_page_keywords)) none @endif'>
                                                <table id="keywords_d_table" class="table table-bordered">
                                                    ...
                                                    <tbody>
  <!--$first_page_keywords-->
@if(!empty($dynamic_page_keywords))
@foreach($dynamic_page_keywords as $keyword)
...
<tr>
    ...
    <td><p>{{$keyword->price}}</p></td>
     <td><p>{{$keyword->total}}</p></td>
    <td>  <button  type="button" class="btn btn-danger d_delete2" title="delete"><i class="far fa-trash-alt"></i> </button></td>
    </tr>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="formItemVendor">
                                    <button type="submit" id='add_btn' class="btn btn-success ">
                                        <i class="fas fa-check"></i> {{__('front.Save')}}
                                    </button>
...
<script>
 ...
 let total;
        $('#keywordstable').on('click', '.f_delete', function(e) {
         ...
         $('#keywordstable').on('click', '.f_delete2', function(e) {
                // alert('hi');
            $(this).closest('tr').remove()
        })
        $('#keywords_d_table').on('click', '.d_delete', function(e) {
          ...
          $('#keywords_d_table').on('click', '.d_delete2', function(e) {
            $(this).closest('tr').remove()
        })
...
position2 = $('#dynamic_position').val();
        ...
        $('#add_btn').click(function() {
            ...
            form.append('product_desc', $('#product_desc').val());
             form.append('product_desc_ar', $('#product_desc_ar').val());
        ...
        for (var i = 0; i < TotalImages; i++) {
         ...
         var Totalvideos = $('#video')[0].files.length;
        var videos = $('#video')[0];

        for (var j = 0; j < Totalvideos; j++) {
            form.append('video[]', videos.files[j]);
        }

            $.ajax({
                url: "{{route('individualProductEdit_post')}}",
                type: "POST",
                data: form,
                cache: false,
                contentType: false,
                ...
                processData: false,
      beforeSend: function() { 
      $("#add_btn").html("<option>  {{__('front.Loading ...')}}</option>");
      $("#add_btn").prop('disabled', true); // disable button
    },
                success: function(response) {
                    location.reload();
                ...
                $(".alert-danger3").css("display", "block");
...
// -------
   $("#first_page_keywrd_input").change(function() {
        ...
        $.ajax({
            url: "{{route('keywords_details',"+name+")}}" ,
            type: "GET",
        ...
        $.each(files, function(key, file) {
            ...
            reader.onload = function(e) {
                ...
                $("#s_prev_img").attr("src",e.target.result);  
                 ...
                 $html="<div class='col-lg-3 col-md-3 col-sm-12 col-xs-12 weyy' > <div"+ 
"class='formItemVendor'><a href='"+e.target.result+"' class='Itemmm'><div class='sliderimgItem'><img  src='"+e.target.result+"'><button "+
"type='button' class='Removee RemoveImg RemoveProductImage'><i class='far"+
" fa-trash-alt' aria-hidden='true'></i></button></div></a> </div></div>";
 $("#gallary_imgs").append($html);

            }
        });
    }
     function changeVideoPreview(e, k, v) {
        var files = e.target.files;
        // console.log(files)
  ...
  $html=  ' <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 weyy"> <div class="formItemVendor"> <div class="sliderimgItem"><video class="VedioPorUpload"  controls><source src="'+e.target.result+'" type="video/mp4"></video> <button type="button" class="Removee RemoveVideo RemoveProductImage" ><i class="far fa-trash-alt"></i> </button></div></div</div>   ';                                                                  
                                        
 $(".sliderimgItemV").append($html);
